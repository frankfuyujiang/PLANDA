...
namespace NotificationWindow
{
    ...
    internal class PopupNotifierForm : System.Windows.Forms.Form
    {
        ...
        private void PopupNotifierForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            /*if (Parent.ShowGrip)
            {
                e.Graphics.DrawImage(Properties.Resources.panda, (int)((this.Width - Properties.Resources.panda.Width) / 2), (int)((Parent.HeaderHeight - 3) / 2));
            ...
            */
            ...
            if (Parent.Image != null)
            {
                e.Graphics.DrawImage(Properties.Resources.panda, Parent.ImagePadding.Left, Parent.HeaderHeight + Parent.ImagePadding.Top, Parent.ImageSize.Width, Parent.ImageSize.Height);
            }
